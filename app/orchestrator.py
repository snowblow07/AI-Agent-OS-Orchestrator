...
def log_event(intent_hash, event_type, payload, parent_hash=None):
    ...
    cursor = conn.cursor()
    cursor.execute(
        "INSERT INTO execution_log (intent_hash, parent_intent_hash, event_type, payload) VALUES (?, ?, ?, ?)",
